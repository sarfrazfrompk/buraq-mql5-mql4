...
function OpenFileInMetaEditor(uri) {
    const extension = pathModule.extname(uri.fsPath), config = vscode.workspace.getConfiguration('buraq_mql5_mql4'), wn = vscode.workspace.name.includes('MQL4'), fileName = pathModule.basename(uri.fsPath);
    let MetaDir, CommM;
