...
function CreateProperties() {
    const config = vscode.workspace.getConfiguration(), configMql = vscode.workspace.getConfiguration('buraq_mql5_mql4'), workspacepath = vscode.workspace.workspaceFolders[0].uri.fsPath, 
    ...
    config.update('buraq_mql5_mql4.context', true, false);
