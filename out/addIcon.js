...
function add_material(NameExt, extenPath){
    ...
    pathModule.join(extenPath, 'buraq-mql5-mql4-icons', folderName)
    ...
    ['mq4.svg', 'mq5.svg', 'ex4.svg', 'ex5.svg', 'mqh.svg'].forEach(x => {
        fs.copyFileSync(
            ...
            pathModule.join(extenPath, 'buraq-mql5-mql4-icons', folderName, x)
        )
    });

    let obj = {
        '*.ex4': `../../buraq-mql5-mql4-icons/${folderName}/ex4`,
        '*.ex5': `../../buraq-mql5-mql4-icons/${folderName}/ex5`,
        '*.mq4': `../../buraq-mql5-mql4-icons/${folderName}/mq4`,
        '*.mq5': `../../buraq-mql5-mql4-icons/${folderName}/mq5`,
        '*.mqh': `../../buraq-mql5-mql4-icons/${folderName}/mqh`,
    };
...
function add_vsicons(NameExt, extenPath){
    ...
    config.update('vsicons.customIconFolderPath', pathModule.join(extenPath, 'buraq-mql5-mql4-icons'), true);
